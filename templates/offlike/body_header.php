          ...
          <td>
            <div id="hp">
              ...
              <div class="top-nav-container">
                <div onMouseOver="myshow('countryDropDown');" OnMouseOut="myhide('countryDropDown');" style="position: absolute; right: 80px; top: 38px; z-index:99; width: 145px;">
                  <div style="overflow: hidden; visibility: inherit; display: block; cursor: default; background-color: transparent; background-image: url(<?php echo $config['template_href'];?>images/countrymenu-bg.gif); height: 19px; padding-left: 9px; padding-top: 2px;"><a class="menuFiller">Choose a language:</a><img src="<?php echo $config['template_href'];?>images/pixel.gif"></div>
                ...
                <div onMouseOver="myshow('contextDropDown');" OnMouseOut="myhide('contextDropDown');" style="position: absolute; right: 240px; top: 38px; z-index:99; width: 145px;">
                  <div style="overflow: hidden; visibility: inherit; display: block; cursor: default; background-color: transparent; background-image: url(<?php echo $config['template_href'];?>images/countrymenu-bg.gif); height: 19px; padding-left: 9px; padding-top: 2px;"><a class="menuFiller">Context menu:</a><img src="<?php echo $config['template_href'];?>images/pixel.gif"></div>
