        ...
        <td>
            <table cellpadding="3" cellspacing="0" width="100%">
                ...
                <tr>
                    ...
                    <td class="rankingHeader" align="center" nowrap="nowrap" width="90">Type&nbsp;</td>
                    <td class="rankingHeader" align="center" nowrap="nowrap" width="90">Population&nbsp;</td>
                    <td class="rankingHeader" align="center" nowrap="nowrap" width="90">Max Players&nbsp;</td>
					<td class="rankingHeader" align="center" nowrap="nowrap" width="120">Uptime&nbsp;</td>
                </tr>
                <tr>
                    <td colspan="6" background="<?php echo $config['template_href'];?>images/shadow.gif">
