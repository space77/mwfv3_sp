	...
	<tbody>
        <tr>
            ...
            <div style="border: 2px dotted #cdcdcd;background:none;margin:4px;padding:6px 9px 6px 9px;text-align:right;width:93%;">
                <img onClick="window.close();" src="images/cancel_f2.png" style="float:left;cursor:pointer;" alt="<?php Lang('close');?>" title="Закрыть" align="absmiddle">
		...
		<tr style="text-align: center;">
			...
			<td class="windowbg" align="center"><a href="index.php?n=forum&sub=attach&action=delete&attid=<?php echo $attach['attach_id']; ?>&tid=<?php echo$_GET['tid'];?>" title="<?php Lang('delete');?>"><img src="images/trash.png" alt="[del]" align="absmiddle"></a></td>
		</tr>
		<?php } ?>
