                                            ...
                                            <div id="avatar<?php echo $post['bg']; ?>1">
                                                ...
                                                <div style="position: relative;">
                                                    ...
                                                    <div id="iconpanelhide11">
                                                        ...
                                                        <div class="player-icons-race" style="background: url('<?php echo $config['template_href'];?>images/icon/race/5-1.gif') no-repeat;" onmouseover="ddrivetip('<b>Undead</b>','#ffffff')"; onmouseout="hideddrivetip()">
                                                            <img src="<?php echo $config['template_href'];?>images/pixel.gif" height="18" width="18" alt="" />
                                                        </div>
                                                        <div class="player-icons-class" style="background: url('<?php echo $config['template_href'];?>images/icon/class/9.gif') no-repeat;" onmouseover="ddrivetip('<b>Warlock</b>','#ffffff')"; onmouseout="hideddrivetip()">
                                                            <img src="<?php echo $config['template_href'];?>images/pixel.gif" height="18" width="18" alt="" />
                                                        </div>
                                                        <div class="player-icons-pvprank" style="background: url('<?php echo $config['template_href'];?>images/icon/pvpranks/rank_default_1.gif') no-repeat;"></div>
                                                        </div>
                                                    </div>
                                                    -->
                                                </div><!-- end shell -->
                                                ...
                                                <div class="pinfobackground">
                                                    ...
                                                    <div>
                                                        <ul class="listinfo" style="clear: both;">
                                                            ...
                                                            <li><small><b><a href="<?php echo $post['linktopms']; ?>"><?php echo $lang['pers_mess'];?></a></b></small></li>
                                                        </ul>
                                                    </div>
...
<?php if($post['edited']){ ?><p><small><font color="red">[ Post edited by <?php echo $post['edited_by'].' &nbsp;'; echo date('d-m-Y H:i:s',$post['edited']);?> ]<br/></font></small></p><?php } ?> 
                                                            </span>
                                                            </div>
                                                        </div>
                                                    </td>
