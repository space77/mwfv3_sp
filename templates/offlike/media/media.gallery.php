...
<?php
		...
		$cat_id = 'SELECT category_id FROM site_category WHERE category = "fanart"';
...
<center>	<table cellspacing = "0" cellpadding = "0" border = "0">
		...
		<td colspan = "3">
			...
			<tr>
				...
				<td valign = "top">
					...
					<tr>
						<?php if ($image == 1) { } else { ?>
						<td><span><a href = "index.php?n=media&sub=gallery&i=<?php echo $previmg;?>">Previous Image</a></span></td>
						<?php }?>
					</tr>
					<tr>
	...
	<table cellspacing = "0" cellpadding = "0" border = "0" background = "./templates/offlike/images/ss-border-bot-right.gif">
					...
					<tr>
						...
						<td align = "right"><span><a href = "index.php?n=media&sub=gallery&i=<?php echo $nextimg;?>">Next Image</a></span></td>
						<?php }?>
					</tr>
