<?php if(isset($_GET['id']) && $_GET['id']>0 && $profile){ ?>
    <table align="center" width="100%" style="font-size:0.8em;"><tr><td align="center">
        ...
        <div style="border: 2px dotted #1E4378;background:none;margin:4px;padding:6px 9px 6px 9px;text-align:right;width:70%;">
            <b>Username (login)</b> <input type="text" name="profile[username]" size="24" value="<?php echo$profile['username'];?>" style="margin:1px;"> <br>
            <b>Email</b> <input type="text" name="profile[email]" size="24" value="<?php echo$profile['email'];?>" style="margin:1px;"> <br>
            <?php if($user['gmlevel']==3){ ?><b>GM level</b> <input type="text" name="profile[gmlevel]" size="1" value="<?php echo$profile['gmlevel'];?>" style="margin:1px;"> <br><?php } ?>
            <b>Locked</b> <input type="text" name="profile[locked]" size="1" value="<?php echo$profile['locked'];?>" style="margin:1px;"> <br>
        </div>
...
<table border="0" cellspacing="1" cellpadding="4" align="center" width="100%" class="bordercolor" style="font-size:0.8em;">
  <tbody>
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%" class="bordercolor"style="font-size:1em;">
          <tbody><tr>
            ...
            <td align="right">
              ...
              <a href="index.php?n=admin&sub=members&char=z">Z</a> 
              </b>
            </td>
          </tr>
        </tbody></table>
    ...
    <tr style="text-align: center;">
      <td class="windowbg2">
        <a href="index.php?n=account&sub=pms&action=add&to=<?php echo $item['username']; ?>" title="<?php echo $lang['personal_message'];?>"><img src="<?php echo$config['template_href'];?>images/icons/email.gif" alt="[PM]" align="middle"></a>
      </td>
      ...
      <td class="windowbg2"><a href="mailto:<?php echo $item['email']; ?>"><?php echo $item['email']; ?></a></td>
      ...
      <td class="windowbg" align="center"><b><?php echo ($item['locked']==1?'<font color=red>0</font>':'<font color=green>1</font>'); ?> / <?php echo ($item['active']==1?'<font color=red>1</font>':'<font color=green>0</font>'); ?></b></td>
    </tr>
    <?php } ?>
    <tr>
