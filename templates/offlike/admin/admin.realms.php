...
<?php if(empty($_GET['action'])){ ?>
    ...
    <form action="index.php?n=admin&sub=realms&action=create" method="post" onSubmit="return popup_ask('<?php echo $lang['sure_q'];?>');">
        <tr>
            <td colspan="8" style="background:#a7a7a7;height:8px;border:2px solid #000;"><img src="<?php echo $config['template_href'];?>images/pixel.gif"></td>
        </tr>
        <tr>
            <td width="12">#</td>
            ...
            <td><input type="text" name="CharacterDatabaseInfo" style="width:100%;font-size:0.7em;"></td>
            <td><input type="text" name="WorldDatabaseInfo" style="width:100%;font-size:0.7em;"></td>
        </tr>
        <tr>
            <td colspan="8" style="background:#a7a7a7;height:8px;border:2px solid #000;">
...
<?php foreach($items as $item){ ?>
        <tr class="normal">
            ...
            <td style="font-size:0.8em;"><?php echo $item['CharacterDatabaseInfo']; ?></td>
            <td style="font-size:0.8em;"><?php echo $item['WorldDatabaseInfo']; ?></td>
        </tr>
<?php } ?>
    </tbody>
...
<script language="javascript">
    ...
    <form action="index.php?n=admin&sub=realms&action=update&id=<?php echo $item['id']; ?>" method="post" onSubmit="return confirm('<?php echo $lang['sure_q'];?>');">
        <tr>
            ...
            <td><input type="text" name="CharacterDatabaseInfo" value="<?php echo $item['CharacterDatabaseInfo']; ?>" style="width:100%;font-size:0.7em;"></td>
            <td><input type="text" name="WorldDatabaseInfo" value="<?php echo $item['WorldDatabaseInfo']; ?>" style="width:100%;font-size:0.7em;"></td>
        </tr>
        <tr>
            <td colspan="8" style="background:#a7a7a7;height:8px;border:2px solid #000;">
