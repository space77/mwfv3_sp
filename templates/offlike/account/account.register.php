...
p.nm, p.wm { 
    ...
    <div style="padding-left:8px;">
        ...
        <label for="r_login"><b><?php Lang('username');?>:</b></label><input type="text" id="r_login" name="r_login" size="40" maxlength="17" onblur="check_login();">
        <p id="t_login" style="display:none;" class="wm"></p>

        <label for="r_pass"><b><?php Lang('pass');?>:</b></label><input type="password" id="r_pass" name="r_pass" size="40" maxlength="17" onblur="check_pass();">
        <p id="t_pass" style="display:none;" class="wm"></p>

        <label for="r_cpass"><b><?php Lang('cpass');?>:</b></label><input type="password" id="r_cpass" name="r_cpass" size="40" maxlength="17" onblur="check_cpass();">
        ...
        <p><input type="submit" class="button" value="<?php Lang('register');?>"></p>
        </form>
    </div>
<?php
    }
