...
<?php } elseif ($_GET['action']=='view' && $_GET['dir']=='out'){ ?>
    ...
    <input type="hidden" name="deletem" value="deletem">
        <table id="notification_body" class="forum_category" width="100%">
            ...
            <tbody>
                <tr class="normal">
                    <td class="n_checkbox" width="22">&nbsp;</td>
                    <td class="n_sender" width="130"><?php Lang('post_for');?></td>
                    <td class="n_title"><?php Lang('post_subj');?></td>
                    <td class="n_time" width="140"><?php Lang('time');?></td>
                </tr>
<?php foreach($items as $item){ ?>
                <tr class="normal <?php echo ($item['showed']=='1'?'read':'unread')?>">
                    <td class="n_checkbox" width="22"><input name="checkpm[]" type="checkbox" value="<?php echo $item['id']; ?>" class="<?php echo ($item['showed']=='1'?'read':'unread')?>" /></td>
                    <td class="n_sender" width="130"><a href="index.php?n=account&sub=view&action=find&name=<?php echo $item['owner'];?>"><?php echo $item['owner']; ?></a></td>
                    <td class="n_title"><a href="index.php?n=account&sub=pms&action=viewpm&iid=<?php echo $item['id']; ?>"><?php echo $item['subject']; ?></a></td>
                    <td class="n_time" width="140"><a href="index.php?n=account&sub=pms&action=viewpm&iid=<?php echo $item['id']; ?>"><?php echo date('d-m-Y, H:i',$item['posted']);?></a></td>
                </tr>
<?php } ?>
