<?php
  class character {
    ...
    // конструктор
    function character($sqlinfo, $mangos_field, $plrStat) {
        ...
        $this->next_level_xp = max($plrStat['xpnextlvl'][min($this->level, 79)],$this->current_xp);
        ...
        $this->honor_points = $sqlinfo['totalHonorPoints'];
        $this->honorable_kills = $sqlinfo['totalKills'];
